# Premium_Music
Sɪᴍᴘʟᴇ Tᴇʟᴇɢʀᴀᴍ Rᴀᴅɪᴏ/Mᴜsɪᴄ Pʟᴀʏᴇʀ Bᴏᴛ Bʏ Pʀɪʏᴏ
# PREMIUM_MUSIC 3.0
...
- `STREAM_URL` : Stream URL of radio station or a youtube live video to stream when the bot starts or with /radio command. Some Streaming Links [Click here.](https://t.me/itspriyo)
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/ItsPriyo/Premium_Music">
  <img src="https://www.herokucdn.com/deploy/button.svg" alt="Deploy">

<details> <summary><b>Deploy on Qovery</b></summary>
<p>
<br/>
<p align="left">
...
```sh
git clone https://github.com/ItsPriyo/Premium_Music
cd Premium_Music
...
#### Support
Join Now Telegram [Support Group](https://t.me/premiumappsaccountfree)
