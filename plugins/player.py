...
async def yplay(_, message: Message):
    ...
    if type=="youtube" or type=="query":
        ...
        try:
            ...
            thumb="https://telegra.ph/file/a96967d7a355b53ebbf0a.jpg"
            pass
        ...
        if " " in m.text:
            ...
            if ytplaylist == "peer":
                markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Gᴇᴛ APʟᴀʏʟɪsᴛ Bᴏᴛ", url=f"https://telegram.me/GetAPlayListBot?start=zautekm_{m.from_user.id}")
                ...
                markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Jᴏɪɴ Mʏ Cʜᴀɴɴᴇʟ", url='https://t.me/premiumappsaccountfree')
                        ],
                        [
                            InlineKeyboardButton("Tʀʏ Aɢᴀɪɴ", url=f"https://telegram.me/GetAPlayListBot?start=zautekm_{m.from_user.id}")
...
async def upload(client, message):
    ...
    if playlist[0][3] == "telegram":
        ...
        await client.send_audio(
            ...
            duration=int(float(dur)),
            performer="MusicPlayer",
            caption=f"<b>Song: [{playlist[0][1]}]({playlist[0][2]})\nUploaded Using [Premium_Music](https://github.com/PriyoKhan777/Premium_Music)</b>"
            )
        await m.delete()
        try:
...
async def not_chat(_, m: Message):
    buttons = [
        ...
        [
            InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/itspriyo'),
